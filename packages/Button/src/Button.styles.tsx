...
export const StyledButton = styled.button`
  ${props =>
    css`
      ...
      cursor: pointer;
      background: ${props.theme.colors.mediumBlueBGamer};

      font-size: ${props.theme.typography.base.fontSize};
      padding: ${props.theme.spacing[4]} ${props.theme.spacing[16]};
      border: ${props.theme.border.width.sm} solid ${props.theme.colors.darkBlueBGamer};
      border-radius: ${props.theme.border.radius.md};
      transition: all 0.3s ease 0s;

      &:hover:not([disabled]) {
        background: ${props.theme.colors.mediumBlueBGamer};
        border: ${`${props.theme.border.width.sm} solid ${props.theme.colors.mediumBlueBGamer}`};
        transform: scale(1.1);
        box-shadow: ${props.theme.shadow['md-dark']};
      }

      &:active:not([disabled]) {
        background: ${props.theme.colors.darkBlueBGamer};
        border: ${`${props.theme.border.width.sm} solid ${props.theme.colors.darkBlueBGamer}`};
        transform: scale(0.9);
      ...
      &:focus:not([disabled]) {
        outline: ${`${props.theme.outline.sm} solid ${props.theme.colors.semiLightBlueBGamer}`};
      }
